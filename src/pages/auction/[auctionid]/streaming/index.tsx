  ...
  return (
    <div className='m-auto flex w-[138rem] select-none flex-col items-center gap-2 py-2'>
      <div className='grid grid-cols-3 gap-[1.25rem] px-2'>
        <div className='text-36-400 col-span-3 bg-slate-200'>상품명(긴제목)</div>
        <div className='col-span-2 flex w-[91rem] flex-col gap-[1.13rem]'>
          ...
          {/* <LiveVideo /> */}
          <div className='text-16-700 flex h-[8rem] w-full flex-row items-center space-x-[1.3rem] rounded-xl bg-stone-50 px-[3.2rem]'>
