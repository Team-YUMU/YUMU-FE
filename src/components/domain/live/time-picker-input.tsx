  ...
  (
    ...
    return (
      <Input
        ...
        name={name || picker}
        className={cn(
          'h-[4rem] w-[6rem] px-[2rem] py-[1rem] text-center font-mono text-16-400 tabular-nums caret-transparent focus:bg-accent focus:text-accent-foreground [&::-webkit-inner-spin-button]:appearance-none',
          className,
        )}
